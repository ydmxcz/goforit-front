<template>
    <div style="width: 100%;">
        ...
        <!-- 表格 -->
        <Table :columns="problemLibraryHeader" :data="data.problemList" style="margin-top: 20px;margin-bottom: 20px;">
            <template #status="{ row }">
...
const conditionSearchProblem = async () => {
    let tags = [];
    data.problemSearchCondition.selectedTagList.forEach((item) => {
        tags.push(item.id)
    })
